...
func (q *Queries) AwardAchievement(ctx context.Context, arg AwardAchievementParams) (UserAchievement, error) {
	row := q.db.QueryRowContext(ctx, awardAchievement, arg.UserID, arg.GuildID, arg.AchievementID)
...
RETURNING user_id, username, featured_badge
`
...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (User, error) {
	...
	var i User
	err := row.Scan(&i.UserID, &i.Username, &i.FeaturedBadge)
	return i, err
}
...
type GetAchievementByIDRow struct {
	...
	IsSecret         sql.NullBool  `json:"isSecret"`
	SortOrder        sql.NullInt32 `json:"sortOrder"`
}

func (q *Queries) GetAchievementByID(ctx context.Context, achievementID string) (GetAchievementByIDRow, error) {
	row := q.db.QueryRowContext(ctx, getAchievementByID, achievementID)
...
type GetAchievementsByCategoryRow struct {
	AchievementID    string        `json:"achievementId"`
	Name             string        `json:"name"`
	Description      string        `json:"description"`
	Icon             string        `json:"icon"`
...
func (q *Queries) GetAchievementsByCategory(ctx context.Context, category string) ([]GetAchievementsByCategoryRow, error) {
	rows, err := q.db.QueryContext(ctx, getAchievementsByCategory, category)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetAchievementsByCategoryRow
	for rows.Next() {
		var i GetAchievementsByCategoryRow
		if err := rows.Scan(
			&i.AchievementID,
			&i.Name,
			&i.Description,
...
const getAchievementsByRequirementType = `-- name: GetAchievementsByRequirementType :many
SELECT 
    achievement_id,
    name,
    description,
...
type GetAchievementsByRequirementTypeRow struct {
	AchievementID    string        `json:"achievementId"`
	Name             string        `json:"name"`
	Description      string        `json:"description"`
	Icon             string        `json:"icon"`
...
func (q *Queries) GetAchievementsByRequirementType(ctx context.Context, requirementType string) ([]GetAchievementsByRequirementTypeRow, error) {
	rows, err := q.db.QueryContext(ctx, getAchievementsByRequirementType, requirementType)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetAchievementsByRequirementTypeRow
	for rows.Next() {
		var i GetAchievementsByRequirementTypeRow
		if err := rows.Scan(
			&i.AchievementID,
			&i.Name,
			&i.Description,
...
type GetAllAchievementsRow struct {
	AchievementID    string        `json:"achievementId"`
	Name             string        `json:"name"`
	Description      string        `json:"description"`
	Icon             string        `json:"icon"`
...
// =============================================
func (q *Queries) GetAllAchievements(ctx context.Context) ([]GetAllAchievementsRow, error) {
	rows, err := q.db.QueryContext(ctx, getAllAchievements)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetAllAchievementsRow
	for rows.Next() {
		var i GetAllAchievementsRow
		if err := rows.Scan(
			&i.AchievementID,
			&i.Name,
			&i.Description,
...
const getTotalAchievementCount = `-- name: GetTotalAchievementCount :one
SELECT COUNT(*) as count FROM achievements
`

func (q *Queries) GetTotalAchievementCount(ctx context.Context) (int64, error) {
	row := q.db.QueryRowContext(ctx, getTotalAchievementCount)
	var count int64
	err := row.Scan(&count)
	return count, err
}

const getUniqueStudyHours = `-- name: GetUniqueStudyHours :one
SELECT COUNT(DISTINCT EXTRACT(HOUR FROM start_time AT TIME ZONE 'Asia/Manila'))::integer
FROM study_sessions
WHERE user_id = $1
`

func (q *Queries) GetUniqueStudyHours(ctx context.Context, userID sql.NullString) (int32, error) {
	row := q.db.QueryRowContext(ctx, getUniqueStudyHours, userID)
	var column_1 int32
	err := row.Scan(&column_1)
	return column_1, err
}

const getUnnotifiedAchievements = `-- name: GetUnnotifiedAchievements :many
SELECT 
    ua.user_id,
    ua.guild_id,
    ua.achievement_id,
...
type GetUnnotifiedAchievementsParams struct {
	UserID  string `json:"userId"`
	GuildID string `json:"guildId"`
}

type GetUnnotifiedAchievementsRow struct {
	UserID        string       `json:"userId"`
	GuildID       string       `json:"guildId"`
	AchievementID string       `json:"achievementId"`
	EarnedAt      sql.NullTime `json:"earnedAt"`
	Name          string       `json:"name"`
	Description   string       `json:"description"`
	Icon          string       `json:"icon"`
	Category      string       `json:"category"`
...
func (q *Queries) GetUnnotifiedAchievements(ctx context.Context, arg GetUnnotifiedAchievementsParams) ([]GetUnnotifiedAchievementsRow, error) {
	rows, err := q.db.QueryContext(ctx, getUnnotifiedAchievements, arg.UserID, arg.GuildID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []GetUnnotifiedAchievementsRow
	for rows.Next() {
		var i GetUnnotifiedAchievementsRow
		if err := rows.Scan(
			&i.UserID,
			&i.GuildID,
			&i.AchievementID,
...
SELECT user_id, username, featured_badge FROM users
WHERE user_id = $1
`
...
const getUserAchievementCount = `-- name: GetUserAchievementCount :one
SELECT COUNT(*) as count
FROM user_achievements
WHERE user_id = $1 AND guild_id = $2
`

type GetUserAchievementCountParams struct {
	UserID  string `json:"userId"`
	GuildID string `json:"guildId"`
}

func (q *Queries) GetUserAchievementCount(ctx context.Context, arg GetUserAchievementCountParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, getUserAchievementCount, arg.UserID, arg.GuildID)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) GetUserAchievements(ctx context.Context, arg GetUserAchievementsParams) ([]GetUserAchievementsRow, error) {
	rows, err := q.db.QueryContext(ctx, getUserAchievements, arg.UserID, arg.GuildID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const getUserFeaturedBadge = `-- name: GetUserFeaturedBadge :one
SELECT 
    u.featured_badge,
    a.name,
    a.description,
...
type GetUserFeaturedBadgeRow struct {
	FeaturedBadge sql.NullString `json:"featuredBadge"`
	Name          sql.NullString `json:"name"`
	Description   sql.NullString `json:"description"`
	Icon          sql.NullString `json:"icon"`
}

func (q *Queries) GetUserFeaturedBadge(ctx context.Context, userID string) (GetUserFeaturedBadgeRow, error) {
	row := q.db.QueryRowContext(ctx, getUserFeaturedBadge, userID)
	var i GetUserFeaturedBadgeRow
	err := row.Scan(
		&i.FeaturedBadge,
		&i.Name,
		&i.Description,
...
func (q *Queries) HasAchievement(ctx context.Context, arg HasAchievementParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, hasAchievement, arg.UserID, arg.GuildID, arg.AchievementID)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
const hasDawnToDuskDay = `-- name: HasDawnToDuskDay :one
SELECT EXISTS(
  SELECT 1 FROM (
...
func (q *Queries) HasDawnToDuskDay(ctx context.Context, userID sql.NullString) (bool, error) {
	row := q.db.QueryRowContext(ctx, hasDawnToDuskDay, userID)
	var has_dawn_to_dusk bool
	err := row.Scan(&has_dawn_to_dusk)
	return has_dawn_to_dusk, err
}

const markAchievementNotified = `-- name: MarkAchievementNotified :exec
UPDATE user_achievements
SET notified = TRUE
WHERE user_id = $1 AND guild_id = $2 AND achievement_id = $3
`

type MarkAchievementNotifiedParams struct {
	UserID        string `json:"userId"`
	GuildID       string `json:"guildId"`
	AchievementID string `json:"achievementId"`
}

func (q *Queries) MarkAchievementNotified(ctx context.Context, arg MarkAchievementNotifiedParams) error {
	_, err := q.db.ExecContext(ctx, markAchievementNotified, arg.UserID, arg.GuildID, arg.AchievementID)
	return err
}
...
const setFeaturedBadge = `-- name: SetFeaturedBadge :exec
UPDATE users
SET featured_badge = $2
WHERE user_id = $1
`

type SetFeaturedBadgeParams struct {
	UserID        string         `json:"userId"`
	FeaturedBadge sql.NullString `json:"featuredBadge"`
}

func (q *Queries) SetFeaturedBadge(ctx context.Context, arg SetFeaturedBadgeParams) error {
	_, err := q.db.ExecContext(ctx, setFeaturedBadge, arg.UserID, arg.FeaturedBadge)
	return err
}
